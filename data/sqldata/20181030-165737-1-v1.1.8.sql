...
CREATE TABLE `ey_admin` (
  ...
  `role_id` int(10) DEFAULT '0' COMMENT '角色组ID（-1表示超级管理员）',
...
-- Records of `ey_admin`
-- -----------------------------
INSERT INTO `ey_admin` VALUES ('1', 'admin', 'admin', '', '', '7959ec68e999edd0380ff0809f76fa42', '1540889626', '127.0.0.1', '3', 'jct8hlar18p8puuc31qr0tenf4', '-1', '1', '1540889114', '0');
